var Algorithms;
(function (Algorithms) {
    var _Kruskal = (function () {
        function _Kruskal(graph) {
            this.edges = [];
            this.visited = [];
            this.spanningTree = [];
            this.graph = graph;
        }
        _Kruskal.prototype.findMinimalSpanningTree = function () {
            var adjacencyMatrix = this.graph.getAdjacencyMatrix().slice();
            console.log(adjacencyMatrix);
            var finished = false;
            var sortedEdges = this.graph.getEdges().sort(function (edge1, edge2) {
        ...
        _Kruskal.prototype.checkCycle = function (spanningTreeMatrix, source) {
    ...
    Algorithms._Kruskal = _Kruskal;
})(Algorithms || (Algorithms = {}));
//# sourceMappingURL=_Kruskal.js.map