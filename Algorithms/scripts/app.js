    ...
    Graph: {
        ...
        algorithms: {
            ...
            kruscal: function () {
                ...
                console.log('Kruscal');
                console.log(kr.edges.map(function (v, i, arr) { return v.source.name + " - " + v.sink.name + "    " + v.value; }));
            }
        },
        ...
        createEdge: function (node1, node2, value) {
            var graph = App.Graph.current.getGraph();
